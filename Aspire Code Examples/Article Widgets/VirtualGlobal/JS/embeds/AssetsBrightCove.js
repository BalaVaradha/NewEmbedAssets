/*!
Bright Cove specific functions
 */

//set this so can check if script already loaded
var AssetsBrightCoveScript="1";
...
console.log(AssetOptions,"AssetOptions");
        ...
        $( EmbedSettings.selector ).brightcoveVideo(EmbedSettings);
        var AssetContent=$( EmbedSettings.selector).html();
        return AssetContent;
    } );        
//   ;
}
